...
public class Room implements Closeable {
  ...
  private UserSession currentAdmin;
  private UserSession currentController;

  public String getName() {
    return name;
  }
  public JsonArray roomMsg = new JsonArray();
  ...
  public void setAdmin(UserSession session) {
    this.currentAdmin = session;
  }

  public UserSession getAdmin() {
    return this.currentAdmin;
  }

  public void setController(UserSession session) {
    this.currentController = session;
  }

  public UserSession getController() {
